...
>Objective: Classify iris flowers into 3 species (setosa, versicolor, virginica) using sepal/petal measurements.
...
> Code Structure
1.Load Iris dataset (sklearn)
2.EDA + feature analysis
3.Train/test split (80/20)
4.Logistic Regression training
5.100% accuracy evaluation
6.Predict new flower species
